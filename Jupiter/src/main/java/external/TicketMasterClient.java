...
public class TicketMasterClient {
	...
	private static final String API_KEY = "TrQNDHjpoxv6CANYYBCj7tUvGdU1h0Jp";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			// RESPONSE BODY
			BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream())); // stream from ticket master 
			String line;
